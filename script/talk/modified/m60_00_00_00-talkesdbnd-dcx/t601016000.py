...
def t601016000_1():
    """State 0,1"""
    t601016000_x0(shop1=101950, shop2=101974)
    Quit()

def t601016000_x0(shop1=101950, shop2=101974):
    """State 0"""
    if not IsClientPlayer():
        """State 1"""
        Label('L0')
        call = t601016000_x1(shop1=shop1, shop2=shop2)
        if IsClientPlayer():
            """State 2"""
            Label('L1')
            call = t601016000_x2()
...
def t601016000_x1(shop1=101950, shop2=101974):
    """State 0"""
    while True:
        """State 2"""
        # actionbutton:6580:"Examine altar"
        assert t601016000_x5(actionbutton1=6580, flag1=6001, flag2=6000, flag3=6000, flag4=6000, flag5=6000, flag6=6000)
        """State 1"""
        ...
        def WhilePaused():
            ...
            GiveSpEffectToPlayerIf((DoesPlayerHaveSpEffect(9611) == 1 or DoesPlayerHaveSpEffect(9612) == 1) and DidYouDoSomethingInTheMenu(0) == 1,
                                   9613)
        assert t601016000_x3(shop1=shop1, shop2=shop2) or (GetDistanceToPlayer() > 3 or HasPlayerBeenAttacked())
        """State 4"""
...
def t601016000_x3(shop1=101950, shop2=101974):
    """State 0"""
    while True:
        """State 1"""
        ClearTalkListData()
