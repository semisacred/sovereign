...
$Event(0, Default, function() {
    ...
    $InitializeEvent(0, 5750004);       
    $InitializeEvent(0, 5750009);
    $InitializeEvent(0, 5750010);        
    $InitializeEvent(0, 5750011); 
    $InitializeEvent(0, 5750015);   
    $InitializeEvent(0, 5750017);
    $InitializeEvent(0, 5750018); 
    $InitializeEvent(0, 5750019);
    $InitializeEvent(0, 5750020);    
    $InitializeEvent(0, 5750030);    
    $InitializeEvent(0, 5750031);
    $InitializeEvent(0, 5750032);  
    $InitializeEvent(0, 5750033); 
    $InitializeEvent(0, 5750034); 
    $InitializeEvent(0, 5750040);   
    $InitializeEvent(0, 5750041);      
    $InitializeEvent(0, 5750045);  
    $InitializeEvent(0, 5750046);    
    $InitializeEvent(0, 5750055); 
    $InitializeEvent(0, 5750065);    
    $InitializeEvent(0, 5750080);
    $InitializeEvent(0, 5750082);
...
// SACRED Ring of Miquella (Oath of Order / Golden Order)
...
// SACRED Startup 1
$Event(5750000, Default, function() {
    WaitFixedTimeSeconds(0.06);
    // Oath Icon
    if (CharacterHasSpEffect(10000, 274)) {
        SetSpEffect(10000, 261);
    }
    $InitializeEvent(0, 5750013);
    // Ultimate Attack Icon
    SetSpEffect(10000, 277);
    // Deflection Stage Icon
    $InitializeEvent(0, 5750043);
    EndEvent();
});

// SACRED Startup 2
$Event(5750001, Restart, function() {
    // Nemesis Icons 
    if (!(!EventFlag(181) && EventFlag(50))) {
        if (EventFlag(1055420001)) {
            SetSpEffect(10000, 1626995);
            $InitializeEvent(0, 5750110);
        } else if (EventFlag(1055420003)) {
            SetSpEffect(10000, 1626997);
    ...
    WaitFixedTimeSeconds(0.1);
    // Blasphemous Blade Bleed VFX Fix
    if (CharacterHasSpEffect(10000, 1626022)) {
        SetSpEffect(10000, 1626021);
    }
    // Rune Arc / Darklight Arc Recipes
    SetEventFlagID(1055420080, OFF);
    SetEventFlagID(1055420081, OFF);
    SetEventFlagID(1055420082, OFF);
    SetEventFlagID(1055420083, OFF);
    SetEventFlagID(1055420084, OFF);
    SetEventFlagID(1055420085, OFF);
    SetEventFlagID(1055420086, OFF);
    SetEventFlagID(1055420087, OFF);
    SetEventFlagID(1055420090, OFF);
    SetEventFlagID(1055420091, OFF);
    SetEventFlagID(1055420092, OFF);
    SetEventFlagID(1055420093, OFF);
    SetEventFlagID(1055420094, OFF);
    SetEventFlagID(1055420095, OFF);
    SetEventFlagID(1055420096, OFF);
    SetEventFlagID(1055420097, OFF);
    if (!EventFlag(1055420000)) {
        if (EventFlag(187)) {
            SetEventFlagID(1055420087, ON);
        }
        else if (EventFlag(186)) {
            SetEventFlagID(1055420086, ON);
        }
        else if (EventFlag(185)) {
            SetEventFlagID(1055420085, ON);
        }
        else if (EventFlag(184)) {
            SetEventFlagID(1055420084, ON);
        }
        else if (EventFlag(183)) {
            SetEventFlagID(1055420083, ON);
        }
        else if (EventFlag(182)) {
            SetEventFlagID(1055420082, ON);
        }
        else if (EventFlag(181)) {
            SetEventFlagID(1055420081, ON);
        }
        else if (EventFlag(180)) {
            SetEventFlagID(1055420080, ON);
        }
    } else {
        if (EventFlag(187)) {
            SetEventFlagID(1055420097, ON);
        }
        else if (EventFlag(186)) {
            SetEventFlagID(1055420096, ON);
        }
        else if (EventFlag(185)) {
            SetEventFlagID(1055420095, ON);
        }
        else if (EventFlag(184)) {
            SetEventFlagID(1055420094, ON);
        }
        else if (EventFlag(183)) {
            SetEventFlagID(1055420093, ON);
        }
        else if (EventFlag(182)) {
            SetEventFlagID(1055420092, ON);
        }
        else if (EventFlag(181)) {
            SetEventFlagID(1055420091, ON);
        }
        else if (EventFlag(180)) {
            SetEventFlagID(1055420090, ON);
        }
    }
    // Load SpEffects
    SetSpEffect(10000, 188);     
    SetSpEffect(10000, 340);
    SetSpEffect(10000, 342);
    SetSpEffect(10000, 343);   
    SetSpEffect(10000, 344);
    SetSpEffect(10000, 345);
    SetSpEffect(10000, 346);
    SetSpEffect(10000, 347);
    SetSpEffect(10000, 348);
    ClearSpEffect(10000, 2015);
    ClearSpEffect(10000, 2016);
    ClearSpEffect(10000, 2017);
    ClearSpEffect(10000, 2018);
    WaitFixedTimeSeconds(0.3);
    // Giant's Flame Potency
    if (!EventFlag(9131) || EventFlag(111) || EventFlag(112)) {
        SetSpEffect(10000, 1626857);  
        WaitFixedTimeSeconds(0.5);    
        SetSpEffect(10000, 1626849);
    }
    // Betrayer's Dragonbolt
    SetSpEffect(10000, 1626720);
    EndEvent();
});

// SACRED State Info Check 1
$Event(5750002, Default, function() {
    // Torrent
    if (PlayerHasItem(ItemType.Goods, 130)) {
        SetSpEffect(10000, 322);
    }
    // Lantern
    if (PlayerHasItem(ItemType.Goods, 2070)) {
        SetSpEffect(10000, 323);
    }    
    // Endure
    if (EventFlag(100810)) {
        SetSpEffect(10000, 324);
    }
    // Margit's Shackle
    if (PlayerHasItem(ItemType.Goods, 2140)) {
        SetSpEffect(10000, 325);
    }
    // End Condition
    if (CharacterHasSpEffect(10000, 322) && CharacterHasSpEffect(10000, 323) && CharacterHasSpEffect(10000, 324) 
    && CharacterHasSpEffect(10000, 325)) {
        EndEvent();
    }
...
// SACRED State Info Check 2
$Event(5750003, Default, function() { 
    // Flame Cleanse Me
    if (PlayerHasItem(ItemType.Goods, 6040)) {
        SetSpEffect(10000, 326);
    }
    // Flame Grant Me Strength
    if (PlayerHasItem(ItemType.Goods, 6050)) {
        SetSpEffect(10000, 327);
    }
    // Flame Protect Me
    if (PlayerHasItem(ItemType.Goods, 6060)) {
        SetSpEffect(10000, 328);
    }
    // End Condition
    if (CharacterHasSpEffect(10000, 326) && CharacterHasSpEffect(10000, 327) && CharacterHasSpEffect(10000, 328)) {
        EndEvent();
    }
    WaitFixedTimeSeconds(10);  
    RestartEvent();
...
// SACRED State Info Check 3
$Event(5750004, Default, function() {
    // Pureblood Knight's Medal / Mohgwyn's Sacred Spear
    if (PlayerHasItem(ItemType.Goods, 2160) || PlayerHasItem(ItemType.Weapon, 17010000)) {
        SetSpEffect(10000, 330);
    }
    // Blasphemous Claw
    if (PlayerHasItem(ItemType.Goods, 2080)) {
        SetSpEffect(10000, 331);
    }
    // End Condition
    if (CharacterHasSpEffect(10000, 330) && CharacterHasSpEffect(10000, 331)) {
        EndEvent();
    }
...
// SACRED Great Rune Passives
$Event(5750010, Restart, function() {
    if (PlayerHasItem(ItemType.Goods, 191)) {
        SetSpEffect(10000, 550);
    }
    if (PlayerHasItem(ItemType.Goods, 10080)) {
        SetSpEffect(10000, 555);
    }    
    if (PlayerHasItem(ItemType.Goods, 192)) {
        SetSpEffect(10000, 561);
    }
    if (PlayerHasItem(ItemType.Goods, 193)) {
        SetSpEffect(10000, 565);
    }
    if (PlayerHasItem(ItemType.Goods, 194)) {
        SetSpEffect(10000, 570);
    }
    if (PlayerHasItem(ItemType.Goods, 195)) {
        SetSpEffect(10000, 575);
        SetSpEffect(10000, 576);
    }
    if (PlayerHasItem(ItemType.Goods, 196)) {
        SetSpEffect(10000, 580);
        SetSpEffect(10000, 581);
    }
...
// SACRED Oaths
$Event(5750011, Restart, function() {
    WaitFor(CharacterHasSpEffect(10000, 1626599));
    // Oath of Order
    if (CharacterHasSpEffect(10000, 310500) || CharacterHasSpEffect(10000, 312200)) {
        SetSpEffect(10000, 1643000);
        SetSpEffect(10000, 1660000);
        $InitializeEvent(0, 5750012);
    } 
    // Oath of Golden Order
    if (CharacterHasSpEffect(10000, 310510) || CharacterHasSpEffect(10000, 312210)) {
        SetSpEffect(10000, 1643100);
        SetSpEffect(10000, 1660000);
        $InitializeEvent(0, 5750012);
    } 
    // Oath of Totality
    if (CharacterHasSpEffect(10000, 1626540)) {
        SetSpEffect(10000, 1643100);
        SetSpEffect(10000, 1660000);
        SetSpEffect(10000, 1626563);
        $InitializeEvent(0, 5750060);
        if (CharacterHasSpEffect(10000, 1626680) && CharacterHasSpEffect(10000, 1626682) && CharacterHasSpEffect(10000, 1626683)) {
            ClearSpEffect(10000, 1626684);
            ClearSpEffect(10000, 1626685); 
            ClearSpEffect(10000, 1626686);
            ClearSpEffect(10000, 1626687); 
            SetSpEffect(10000, 1626690);
            ...
            ClearSpEffect(10000, 1626687); 
            SetSpEffect(10000, 1626690);
        } else if (CharacterHasSpEffect(10000, 1626681) && CharacterHasSpEffect(10000, 1626682) && CharacterHasSpEffect(10000, 1626683)) {
            ClearSpEffect(10000, 1626684);
            ClearSpEffect(10000, 1626685); 
            ClearSpEffect(10000, 1626686);
            ClearSpEffect(10000, 1626687); 
            SetSpEffect(10000, 1626691);
            WaitFixedTimeSeconds(0.05);
            ClearSpEffect(10000, 1626684);
            ClearSpEffect(10000, 1626685); 
            ClearSpEffect(10000, 1626686);
    ...
    // Oath of Sin
    if (CharacterHasSpEffect(10000, 1626910)) {
        SetSpEffect(10000, 1626913);
        SetSpEffect(10000, 1626914);
        SetSpEffect(10000, 1626915);
        SetSpEffect(10000, 1626916);
        WaitFixedTimeSeconds(0.2);
        $InitializeEvent(0, 5750105);
        $InitializeEvent(0, 5750012);
        SetSpEffect(10000, 1626998);
        WaitFixedTimeSeconds(1.5);
        SetSpEffect(10000, 1626995);
        $InitializeEvent(0, 5750110);
        $InitializeEvent(0, 5750111);
    } 
    RestartEvent();
});

// SACRED Oath Cooldown
$Event(5750012, Default, function() {
    SetSpEffect(10000, 263);
    SetSpEffect(10000, 264);
    WaitFixedTimeSeconds(6);
    SetSpEffect(10000, 265);
    if (!CharacterHasSpEffect(10000, 274)) {
        SetSpEffect(10000, 275);
    }  
    WaitFixedTimeSeconds(6);
    SetSpEffect(10000, 266);
    if (!CharacterHasSpEffect(10000, 274)) {
        SetSpEffect(10000, 275);
    }  
    WaitFixedTimeSeconds(6);
    SetSpEffect(10000, 267);
    if (!CharacterHasSpEffect(10000, 274)) {
        SetSpEffect(10000, 275);
    }  
    WaitFixedTimeSeconds(6);
    SetSpEffect(10000, 268);
    if (!CharacterHasSpEffect(10000, 274)) {
        SetSpEffect(10000, 275);
    }  
    WaitFixedTimeSeconds(6);
    SetSpEffect(10000, 269);
    if (!CharacterHasSpEffect(10000, 274)) {
        SetSpEffect(10000, 275);
    }  
    WaitFixedTimeSeconds(6);
    SetSpEffect(10000, 270);
    if (!CharacterHasSpEffect(10000, 274)) {
        SetSpEffect(10000, 275);
    }  
    WaitFixedTimeSeconds(6);
    SetSpEffect(10000, 271);
    if (!CharacterHasSpEffect(10000, 274)) {
        SetSpEffect(10000, 275);
    }  
    WaitFixedTimeSeconds(6);
    SetSpEffect(10000, 272);
    if (!CharacterHasSpEffect(10000, 274)) {
        SetSpEffect(10000, 275);
    }  
    WaitFixedTimeSeconds(6);
    SetSpEffect(10000, 273);
    if (!CharacterHasSpEffect(10000, 274)) {
        SetSpEffect(10000, 275);
    }  
    WaitFixedTimeSeconds(5);
    if (!CharacterHasSpEffect(10000, 274)) {
        SetSpEffect(10000, 275);
        ClearSpEffect(10000, 263); 
    }  
    EndEvent();
});

// SACRED Oath Icon
$Event(5750013, Default, function() {
    WaitFor(CharacterHasSpEffect(10000, 274));
    if (!CharacterHasSpEffect(10000, 263)) {
        SetSpEffect(10000, 260);
    } 
    WaitFor(!CharacterHasSpEffect(10000, 274));
    SetSpEffect(10000, 275);
    RestartEvent();
...
// SACRED Ultimate Attack
$Event(5750015, Default, function() {
    WaitFixedTimeSeconds(0.1);
    WaitFor(CharacterHasSpEffect(10000, 101990));
    if (CharacterHasSpEffect(10000, 287)) {
        WaitFor(!CharacterHasSpEffect(10000, 287));
        RestartEvent();
    } else if (CharacterHasSpEffect(10000, 154)) {
        if (CharacterHasSpEffect(10000, 277)) {
            SetSpEffect(10000, 279);
        } else if (CharacterHasSpEffect(10000, 278)) {
            SetSpEffect(10000, 280);
        } else if (CharacterHasSpEffect(10000, 279)) {
            SetSpEffect(10000, 281);
        } else if (CharacterHasSpEffect(10000, 280)) {
            SetSpEffect(10000, 282);
        } else if (CharacterHasSpEffect(10000, 281)) {
            SetSpEffect(10000, 283);
        } else if (CharacterHasSpEffect(10000, 282)) {
            SetSpEffect(10000, 284);
        } else if (CharacterHasSpEffect(10000, 283)) {
            SetSpEffect(10000, 285);
        } else if (CharacterHasSpEffect(10000, 284)) {
            SetSpEffect(10000, 286);
        } else if (CharacterHasSpEffect(10000, 285)) {
            SetSpEffect(10000, 287);
            SpawnOneshotSFX(TargetEntityType.Character, 10000, 902, 7505192);
            PlaySE(10000, SoundType.SFX, 440194);
            PlaySE(10000, SoundType.SFX, 440194);
            PlaySE(10000, SoundType.SFX, 440194);
            PlaySE(10000, SoundType.SFX, 440194);
        } else if (CharacterHasSpEffect(10000, 286)) {
            SetSpEffect(10000, 287);
            SpawnOneshotSFX(TargetEntityType.Character, 10000, 902, 7505192);
            PlaySE(10000, SoundType.SFX, 440194);
            PlaySE(10000, SoundType.SFX, 440194);
...
// SACRED Critical Hit Effects
$Event(5750017, Restart, function() {
    WaitFor(CharacterHasSpEffect(10000, 350501));
    if (CharacterHasSpEffect(10000, 350500)) {
        SetSpEffect(10000, 350503);
    }
    if (CharacterHasSpEffect(10000, 1626022)) {
        SetSpEffect(10000, 350701);
    }
    if (CharacterHasSpEffect(10000, 1626004)) {
        SetSpEffect(10000, 350801);
    }
    WaitFixedTimeSeconds(2);
    RestartEvent();
});
...
$Event(5750018, Restart, function() {
    ...
    if (CharacterHasSpEffect(10000, 1626004)) {
        SetSpEffect(10000, 1626353);
    }
    if (CharacterHasSpEffect(10000, 1626211)) {
        SetSpEffect(10000, 1626200);
    }
    if (EventFlag(1055420010) && EventFlag(1055420002)) {
        PlaySE(10000, SoundType.SFX, 450264);
        PlaySE(10000, SoundType.SFX, 2003000);
        WaitFixedTimeSeconds(0.05);
        PlaySE(10000, SoundType.SFX, 2006000);
        WaitFixedTimeSeconds(0.05);
        PlaySE(10000, SoundType.SFX, 2010000);
        IncrementEventValue(1055422000, 6, 64);
    }
    RestartEvent();
});

// SACRED Death Effects
$Event(5750019, Default, function() {
    WaitFor(CharacterDead(10000));
    if (EventFlag(1055420001)) {
        BatchSetEventFlags(1055422010, 1055422013, OFF); 
        RandomlySetEventFlagInRange(1055422010, 1055422013, ON);
        if (EventFlag(1055422010)) {
        PlaySE(10000, SoundType.SFX, 530181);
        WaitFixedTimeSeconds(0.1);
        PlaySE(10000, SoundType.SFX, 450264);
        PlaySE(10000, SoundType.SFX, 450264);
        WaitFixedTimeSeconds(1);
        $InitializeEvent(0, 5750131);
        }
    } else if (EventFlag(1055420010) && EventFlag(1055420002)) {
        BatchSetEventFlags(1055422010, 1055422013, OFF); 
        RandomlySetEventFlagInRange(1055422010, 1055422013, ON);
        if (EventFlag(1055422010)) {
            $InitializeEvent(0, 5750130);
            WaitFixedTimeSeconds(1);
            $InitializeEvent(0, 5750131);
        } else if (EventFlag(1055422011)) {
            $InitializeEvent(0, 5750130);
            WaitFixedTimeSeconds(1);
            PlaySE(10000, SoundType.SFX, 302571);
            WaitFixedTimeSeconds(0.14);
            PlaySE(10000, SoundType.SFX, 302561);
            ...
            WaitFixedTimeSeconds(1);
            $InitializeEvent(0, 5750131);
        } else if (EventFlag(1055422013)) {
            $InitializeEvent(0, 5750130);
        }
    } else if (EventFlag(1055420010)) {
        BatchSetEventFlags(1055422010, 1055422013, OFF); 
        RandomlySetEventFlagInRange(1055422010, 1055422013, ON);
        if (EventFlag(1055422010)) {
            $InitializeEvent(0, 5750130);
...
// SACRED Dynamic Scaled Set Initialization
$Event(5750020, Restart, function() {
    WaitFixedTimeSeconds(0.5);
    WaitFor(CharacterHasSpEffect(10000, 1626682))
    WaitFor(CharacterHasSpEffect(10000, 1626683))
    WaitFor(CharacterHasSpEffect(10000, 1626680) || CharacterHasSpEffect(10000, 1626681))
    if (!PlayerHasItem(ItemType.Goods, 194) && !PlayerHasItem(ItemType.Goods, 8151)) {
        $InitializeEvent(0, 5750021);
    }
    if (CharacterHasSpEffect(10000, 330)) {
        $InitializeEvent(0, 5750022);
    }
    if (PlayerHasItem(ItemType.Weapon, 34200000)) {
        $InitializeEvent(0, 5750023);
    }
    if (PlayerHasItem(ItemType.Weapon, 34200000) && PlayerHasItem(ItemType.Goods, 194) && CharacterHasSpEffect(10000, 330)) {
        EndEvent();
    }
    WaitFixedTimeSeconds(14); 
    RestartEvent();
...
// SACRED Black Scaled Set
$Event(5750021, Restart, function() {
    WaitFor(PlayerHasItem(ItemType.Goods, 8151))
    WaitFixedTimeSeconds(3);
    if (PlayerHasArmorEquipped(ArmorType.Head, 80000, -1)) {
        RemoveItemFromPlayer(ItemType.Armor, 80000, 1);
        AwardItemLot(7600);
        WaitFixedTimeSeconds(0.5);
    }
    if (PlayerHasArmorEquipped(ArmorType.Body, 80100, -1)) {
        RemoveItemFromPlayer(ItemType.Armor, 80100, 1);
        AwardItemLot(7610);
        WaitFixedTimeSeconds(0.5);
    }
    if (PlayerHasArmorEquipped(ArmorType.Body, 81100, -1)) {
        RemoveItemFromPlayer(ItemType.Armor, 81100, 1);
        AwardItemLot(7640);
        WaitFixedTimeSeconds(0.5);
    }
    if (PlayerHasArmorEquipped(ArmorType.Arms, 80200, -1)) {
        RemoveItemFromPlayer(ItemType.Armor, 80200, 1);
        AwardItemLot(7620);
        WaitFixedTimeSeconds(0.5);
    }
    if (PlayerHasArmorEquipped(ArmorType.Legs, 80300, -1)) {
        RemoveItemFromPlayer(ItemType.Armor, 80300, 1);
        AwardItemLot(7630);
    }
    EndEvent();
});

// SACRED Red Scaled Set
$Event(5750022, Restart, function() {
    if (!CharacterHasSpEffect(10000, 1626680) && !CharacterHasSpEffect(10000, 1626681)) {
        ClearSpEffect(10000, 1626684);
        ClearSpEffect(10000, 1626685); 
        ClearSpEffect(10000, 1626686);
        ClearSpEffect(10000, 1626687); 
    }
    if (!CharacterHasSpEffect(10000, 1626682) || !CharacterHasSpEffect(10000, 1626683)) {
        ClearSpEffect(10000, 1626684);
        ClearSpEffect(10000, 1626685); 
        ClearSpEffect(10000, 1626686);
        ClearSpEffect(10000, 1626687);
        WaitFor(CharacterHasSpEffect(10000, 1626682) && CharacterHasSpEffect(10000, 1626683)) 
        RestartEvent();
    }
    if (CharacterHasSpEffect(10000, 1626684) || CharacterHasSpEffect(10000, 1626686)) {
        WaitFor(!CharacterHasSpEffect(10000, 1626680) || !CharacterHasSpEffect(10000, 1626682) 
        || !CharacterHasSpEffect(10000, 1626683) || (!CharacterHasSpEffect(10000, 1626684) && !CharacterHasSpEffect(10000, 1626686)));
        RestartEvent();
    } else if (CharacterHasSpEffect(10000, 1626685) || CharacterHasSpEffect(10000, 1626687)) {
        WaitFor(!CharacterHasSpEffect(10000, 1626681) || !CharacterHasSpEffect(10000, 1626682) 
        || !CharacterHasSpEffect(10000, 1626683) || (!CharacterHasSpEffect(10000, 1626685) && !CharacterHasSpEffect(10000, 1626687)));
        RestartEvent();
    }
    WaitFor(CharacterHasSpEffect(10000, 1626360) || CharacterHasSpEffect(10000, 1626370));
    ClearSpEffect(10000, 1626690);
    ClearSpEffect(10000, 1626691); 
    if (CharacterHasSpEffect(10000, 1626360)) {
        if (CharacterHasSpEffect(10000, 1626680)) {
            SetSpEffect(10000, 1626684);
        } else if (CharacterHasSpEffect(10000, 1626681)) {
            SetSpEffect(10000, 1626685); 
        }            
    } else if (CharacterHasSpEffect(10000, 1626370)) {
        if (CharacterHasSpEffect(10000, 1626680)) {
            SetSpEffect(10000, 1626686);
        } else if (CharacterHasSpEffect(10000, 1626681)) {
            SetSpEffect(10000, 1626687);               
        }               
    } 
    WaitFixedTimeSeconds(1);
    RestartEvent();
...
// SACRED White Scaled Set
$Event(5750023, Restart, function() {
    WaitFixedTimeSeconds(1);
    WaitFor(CharacterHasSpEffect(10000, 1626080))
    if (!CharacterHasSpEffect(10000, 1626682) || !CharacterHasSpEffect(10000, 1626683)) { 
        RestartEvent();
    }
    if (CharacterHasSpEffect(10000, 1626680)) {
        SetSpEffect(10000, 1626688);
    } else if (CharacterHasSpEffect(10000, 1626681)) {
        SetSpEffect(10000, 1626689); 
    }
    RestartEvent();
});

// SACRED Gold Scaled Set
$Event(5750024, Restart, function() {
    if (!CharacterHasSpEffect(10000, 1626680) && !CharacterHasSpEffect(10000, 1626681)) {
        ClearSpEffect(10000, 1626690);
        ClearSpEffect(10000, 1626691); 
    }
    ...
    if (CharacterHasSpEffect(10000, 1626690)) {
        WaitFor(!CharacterHasSpEffect(10000, 1626680) || !CharacterHasSpEffect(10000, 1626682) || !CharacterHasSpEffect(10000, 1626683))
        RestartEvent();
    } else if (CharacterHasSpEffect(10000, 1626691)) {
        WaitFor(!CharacterHasSpEffect(10000, 1626681) || !CharacterHasSpEffect(10000, 1626682) || !CharacterHasSpEffect(10000, 1626683))
        RestartEvent();
    }
    WaitFixedTimeSeconds(1);
    RestartEvent();
...
// SACRED Dragon Communion Arcane Buff
$Event(5750030, Restart, function() {
     WaitFixedTimeSeconds(0.04);   
    if (EventFlag(9433)) {
        SetSpEffect(10000, 1626390);
        SetSpEffect(10000, 1626404);
    }    
    if (PlayerHasItem(ItemType.Goods, 7000)) {
        SetSpEffect(10000, 1626400);
    }
    if (PlayerHasItem(ItemType.Goods, 7001)) {
        SetSpEffect(10000, 1626401);     
    }
    if (PlayerHasItem(ItemType.Goods, 7010)) {
        SetSpEffect(10000, 1626400);   
    }
    if (PlayerHasItem(ItemType.Goods, 7011)) {
        SetSpEffect(10000, 1626401);
    }
    if (PlayerHasItem(ItemType.Goods, 7020)) {
        SetSpEffect(10000, 1626400); 
    }
    if (PlayerHasItem(ItemType.Goods, 7021)) {
        SetSpEffect(10000, 1626401); 
    }
    if (PlayerHasItem(ItemType.Goods, 7030)) {
        SetSpEffect(10000, 1626400);
    }
    if (PlayerHasItem(ItemType.Goods, 7031)) {
        SetSpEffect(10000, 1626401);
    }
    if (PlayerHasItem(ItemType.Goods, 7040)) {
        SetSpEffect(10000, 1626400);
    }
    if (PlayerHasItem(ItemType.Goods, 7041)) {
        SetSpEffect(10000, 1626401);
    }
    if (PlayerHasItem(ItemType.Goods, 7060)) {
        SetSpEffect(10000, 1626400);
    }
    if (PlayerHasItem(ItemType.Goods, 7080)) {
        SetSpEffect(10000, 1626400);
    }
    if (PlayerHasItem(ItemType.Goods, 7090)) {
        SetSpEffect(10000, 1626402); 
    }
    if (PlayerHasItem(ItemType.Goods, 2007000)) {
        SetSpEffect(10000, 1626403); 
    }
    if (PlayerHasItem(ItemType.Goods, 2007010)) {
        SetSpEffect(10000, 1626403);
    }
    if (PlayerHasItem(ItemType.Goods, 2007020)) {
        SetSpEffect(10000, 1626402);
    }
    EndEvent();
});

//SACRED Dragon Communion Curse Initialization 
$Event(5750031, Restart, function() {
    WaitFixedTimeSeconds(0.04);
    if ((CountEventFlags(TargetEventFlagType.EventFlag, 290500, 290999) >= 8) || 
    ((PlayerHasItem(ItemType.Goods, 6950) || PlayerHasItem(ItemType.Goods, 6941) 
    || PlayerHasItem(ItemType.Goods, 2006910) || PlayerHasItem(ItemType.Goods, 7050) 
    || PlayerHasItem(ItemType.Goods, 2007000) || PlayerHasItem(ItemType.Goods, 2007010)))) {
        SetSpEffect(10000, 1626409);
        SetSpEffect(10000, 1626406);
    }
    EndEvent();    
});

// SACRED Dragon Communion Curse
$Event(5750032, Restart, function() {
    WaitFor(EventFlag(9433));
    WaitFor(!EventFlag(9431));

    if (CharacterHasSpEffect(10000, 1626700)) {
        WaitFor(!CharacterHasSpEffect(10000, 1626700));
        RestartEvent();
    }
    if (CharacterHasSpEffect(10000, 1626077)) {
        RestartEvent();
    }

    if (!CharacterHasSpEffect(10000, 1626409)) {
        if (EventFlag(187)) {
            WaitFor(
                CharacterHasSpEffect(10000, 230) ||
                CharacterHasSpEffect(10000, 231) ||
                CharacterHasSpEffect(10000, 232) ||
                CharacterHasSpEffect(10000, 233) ||
                CharacterHasSpEffect(10000, 234) ||
                CharacterHasSpEffect(10000, 235) ||
                CharacterHasSpEffect(10000, 236)
            );
            SetSpEffect(10000, 1626405);
        ...
        else if (EventFlag(180) || EventFlag(181)) {
            WaitFor(CharacterHasSpEffect(10000, 230));
            SetSpEffect(10000, 1626405);
            WaitFixedTimeSeconds(4);
            RestartEvent();
        }
...
// SACRED Dragon Communion Bayle Curse
$Event(5750033, Default, function() {
    WaitFor(CharacterHasSpEffect(10000, 1626403) && !CharacterHasSpEffect(10000, 1626700));
    if (EventFlag(1055420070)) {
        SetSpEffect(10000, 1626412);
    }
    SetSpEffect(10000, 1626408);
    WaitFor(CharacterHasSpEffect(10000, 230));
    if (CharacterHasSpEffect(10000, 1626700) || CharacterHasSpEffect(10000, 1626077)) {
        RestartEvent();
    }
    SetSpEffect(10000, 1626407);
    WaitFixedTimeSeconds(300);
    RestartEvent();
});

// SACRED Dragon Communion Award Initialization
$Event(5750034, Restart, function() {
    WaitFor(EventFlag(9433));
    $InitializeEvent(0, 5750035);
    $InitializeEvent(0, 5750036);  
    EndEvent();
});
...
//SACRED Frenzied Flame Curse Initialization 
$Event(5750040, Restart, function() {
    WaitFixedTimeSeconds(0.05);
    if (EventFlag(9431) && !CharacterHasSpEffect(10000, 1626700)) {
        SetSpEffect(10000, 1626410);
        SetSpEffect(10000, 1626412);
        ClearSpEffect(10000, 1626404);
        ClearSpEffect(10000, 1626406);
        WaitFixedTimeSeconds(0.1);
        ClearSpEffect(10000, 1626404);
        ClearSpEffect(10000, 1626406);
        WaitFixedTimeSeconds(0.5);
...
// SACRED Fatesever Needle
$Event(5750041, Restart, function() {
    WaitFixedTimeSeconds(0.05);
    if (EventFlag(9431)) {
        SetEventFlagID(1055420070, ON);
    }
    if (!EventFlag(1055420070)) {
        EndEvent();
    }
    if (CharacterHasSpEffect(10000, 1626700)) {
        SetEventFlagID(7500, OFF);
        SetEventFlagID(9431, OFF);
        SetSpEffect(10000, 1626411);
        ClearSpEffect(10000, 1626404);
        ClearSpEffect(10000, 1626406);
        ClearSpEffect(10000, 1626412);
        ClearSpEffect(10000, 1626408);
        WaitFixedTimeSeconds(0.5);
        ClearSpEffect(10000, 1626404);
        WaitFor(!CharacterHasSpEffect(10000, 1626700));
        EndIf(CharacterDead(10000));
        SetSpEffect(10000, 1626410);
        SetSpEffect(10000, 1626412);
        if (CharacterHasSpEffect(10000, 1626403)) {
            SetSpEffect(10000, 1626408);    
        }
        SetEventFlagID(7500, ON);
        SetEventFlagID(9431, ON);
    } else if (!CharacterHasSpEffect(10000, 1626700)) {
        SetEventFlagID(7500, ON);
        SetEventFlagID(9431, ON);
        SetSpEffect(10000, 1626410);
        SetSpEffect(10000, 1626412);
...
// SACRED Deflect Stage Icons
$Event(5750043, Default, function() {
    if (CharacterHasSpEffect(10000, 102007)) {
        SetSpEffect(10000, 102024); 
    } else if (CharacterHasSpEffect(10000, 102008)) {
        SetSpEffect(10000, 102025);
    } else if (CharacterHasSpEffect(10000, 102009)) {
        SetSpEffect(10000, 102026);
    } else if (CharacterHasSpEffect(10000, 102010)) {
        SetSpEffect(10000, 102027);
    } else {  
        SetSpEffect(10000, 102023);
    } 
    WaitFixedTimeSeconds(0.2);
    RestartEvent();
});

// SACRED Ravenous Bloodflame Icons
$Event(5750045, Default, function() {
    WaitFor(CharacterHasSpEffect(10000, 1626211));
    if (CharacterHasSpEffect(10000, 1626241)) {
        SetSpEffect(10000, 1626196); 
    } else if (CharacterHasSpEffect(10000, 1626236)) {
        SetSpEffect(10000, 1626195);
    } else if (CharacterHasSpEffect(10000, 1626231)) {
        SetSpEffect(10000, 1626194);
    } else if (CharacterHasSpEffect(10000, 1626226)) {
        SetSpEffect(10000, 1626193);
    } else if (CharacterHasSpEffect(10000, 1626221)) {
        SetSpEffect(10000, 1626192);
    } else if (CharacterHasSpEffect(10000, 1626216)) {
        SetSpEffect(10000, 1626191);
    } else {  
        SetSpEffect(10000, 1626190);
    } 
    WaitFixedTimeSeconds(0.195);
    RestartEvent();
});

// SACRED Soulflame Heresy Icons
$Event(5750046, Default, function() {
    WaitFor(CharacterHasSpEffect(10000, 1626004));
    if (CharacterHasSpEffect(10000, 1626301)) {
        if (CharacterHasSpEffect(10000, 1626010)) {
            if (CharacterHasSpEffect(10000, 1626341)) {
                SetSpEffect(10000, 1627349); 
            } else if (CharacterHasSpEffect(10000, 1626336)) {
                SetSpEffect(10000, 1627344); 
            } else if (CharacterHasSpEffect(10000, 1626331)) { 
                SetSpEffect(10000, 1627339);
            } else if (CharacterHasSpEffect(10000, 1626326)) { 
                SetSpEffect(10000, 1627334);
            } else if (CharacterHasSpEffect(10000, 1626321)) { 
                SetSpEffect(10000, 1627329);
            } else if (CharacterHasSpEffect(10000, 1626316)) { 
                SetSpEffect(10000, 1627324);
            } else if (CharacterHasSpEffect(10000, 1626311)) { 
                SetSpEffect(10000, 1627319);
            } else if (CharacterHasSpEffect(10000, 1626306)) { 
                SetSpEffect(10000, 1627314);
            } else {
                SetSpEffect(10000, 1627309);
            }
        } else {
            if (CharacterHasSpEffect(10000, 1626341)) {
                SetSpEffect(10000, 1627348); 
            } else if (CharacterHasSpEffect(10000, 1626336)) {
                SetSpEffect(10000, 1627343); 
            } else if (CharacterHasSpEffect(10000, 1626331)) { 
                SetSpEffect(10000, 1627338);
            } else if (CharacterHasSpEffect(10000, 1626326)) { 
                SetSpEffect(10000, 1627333);
            } else if (CharacterHasSpEffect(10000, 1626321)) { 
                SetSpEffect(10000, 1627328);
            } else if (CharacterHasSpEffect(10000, 1626316)) { 
                SetSpEffect(10000, 1627323);
            } else if (CharacterHasSpEffect(10000, 1626311)) { 
                SetSpEffect(10000, 1627318);
            } else if (CharacterHasSpEffect(10000, 1626306)) { 
                SetSpEffect(10000, 1627313);
            } else {
                SetSpEffect(10000, 1627308);
            }
        }
    } else if (CharacterHasSpEffect(10000, 1626010)) {
        SetSpEffect(10000, 1627304); 
    } else {  
        SetSpEffect(10000, 1627303);
    } 
    WaitFixedTimeSeconds(0.195);
    RestartEvent();
});

// SACRED Giant's Flame Potency
$Event(5750055, Default, function() {
    if (EventFlag(111) || EventFlag(112)) {
        EndEvent();
    } else if (EventFlag(9131)) {
        WaitFixedTimeSeconds(2); 
        SetSpEffect(10000, 1626857); 
        EndEvent();
    } 
    WaitFor(CharacterHasSpEffect(10000, 1626850));
    if (CharacterHasSpEffect(10000, 1626859)) {
        SetSpEffect(10000, 1626857); 
        WaitFixedTimeSeconds(0.5);  
        SetSpEffect(10000, 1626856); 
    } else {
        if (CharacterHasSpEffect(10000, 1626855)) {
            SetSpEffect(10000, 1626857); 
            WaitFixedTimeSeconds(0.5);  
            SetSpEffect(10000, 1626856);
        } else if (CharacterHasSpEffect(10000, 1626854)) {
            SetSpEffect(10000, 1626857); 
            WaitFixedTimeSeconds(0.5); 
            SetSpEffect(10000, 1626855); 
        } else if (CharacterHasSpEffect(10000, 1626853)) {
            SetSpEffect(10000, 1626857); 
            WaitFixedTimeSeconds(0.5); 
            SetSpEffect(10000, 1626854); 
        } else if (CharacterHasSpEffect(10000, 1626852)) {
            SetSpEffect(10000, 1626857); 
            WaitFixedTimeSeconds(0.5); 
            SetSpEffect(10000, 1626853); 
        } else if (CharacterHasSpEffect(10000, 1626851)) {
            SetSpEffect(10000, 1626857); 
            WaitFixedTimeSeconds(0.5); 
            SetSpEffect(10000, 1626852); 
        } else if (CharacterHasSpEffect(10000, 1626849)) {
            SetSpEffect(10000, 1626857); 
            WaitFixedTimeSeconds(0.5); 
            SetSpEffect(10000, 1626851); 
        }
    }
    WaitFixedTimeSeconds(0.5);
    RestartEvent();
...
// SACRED Sacred Ward
$Event(5750060, Default, function() {
    WaitFor(!CharacterHasSpEffect(10000, 1626563));
    if (CharacterHasSpEffect(10000, 153)) {
        SetSpEffect(10000, 1626559);
    }
    if (CharacterHasSpEffect(10000, 1626551)) {
        WaitFixedTimeSeconds(0.1); 
        RestartEvent();
    }
    EndEvent();
...
// SACRED Betrayer's Dragonbolt
$Event(5750065, Restart, function() {
    WaitFor(PlayerHasItem(ItemType.Goods, 2006910));         
    WaitFor(CharacterHasSpEffect(10000, 1626740))
    WaitFixedTimeSeconds(1); 
    WaitFor(CharacterHasSpEffect(10000, 1626740))
    WaitFixedTimeSeconds(1); 
    WaitFor(CharacterHasSpEffect(10000, 1626740))
    ...
    WaitFixedTimeSeconds(1); 
    WaitFor(CharacterHasSpEffect(10000, 1626740))
    ClearSpEffect(10000, 1626720);
    EndEvent();
});

// SACRED Divinity Initialization
$Event(5750080, Restart, function() {
    if (PlayerHasItem(ItemType.Weapon, 34100000) || PlayerHasItem(ItemType.Weapon, 34200000)) {
        WaitFor(PlayerHasItem(ItemType.Weapon, 34200000));
        $InitializeEvent(0, 5750081);
        WaitFor(CharacterHasSpEffect(10000, 1626080));
        SetSpEffect(10000, 4301);
    }
    EndEvent();
});

// SACRED Divinity Apply
$Event(5750081, Default, function() {
    WaitFor(CharacterHasSpEffect(10000, 1626063));
    if (CharacterHasSpEffect(10000, 239) && CharacterHasSpEffect(10000, 361000)) {
        SetSpEffect(10000, 1626065);
        WaitFixedTimeSeconds(0.05);  
        RestartEvent();
    } else {
        WaitFixedTimeSeconds(0.05);  
...
// SACRED Divinity Finger Snap Time Change
$Event(5750082, Default, function() {
    WaitFor(CharacterHasSpEffect(10000, 4301));
    WaitFor(CharacterHasSpEffect(10000, 9672));
    if (TimeOfDayInRange(6, 0, 0, 18, 0, 0)) {
        SetCurrentTime(20, 0, 0, false, false, false, 0, 0, 0);
        WaitFixedTimeSeconds(1);
    } else if (!TimeOfDayInRange(6, 0, 0, 18, 0, 0)) {
...
// SACRED Destined Death Initialization
$Event(5750090, Restart, function() {
    if (EventFlag(13000800)) {
        InitializeEvent(0, 5750091, 0);
    }
    EndEvent();
});

// SACRED Destined Death
$Event(5750091, Default, function() {
    WaitFor(PlayerHasItem(ItemType.Weapon, 4020000));
    WaitFor(CharacterHasSpEffect(10000, 1626900));
    ClearSpEffect(10000, 1626901);
    ClearSpEffect(10000, 1626902);
    ClearSpEffect(10000, 1626903);
    SetSpEffect(10000, 1626902);    
    SetSpEffect(10000, 1626901);
    WaitFixedTimeSeconds(0.5);
    RestartEvent();
});

// SACRED Nemesis Startup
$Event(5750100, Default, function() {
    WaitFixedTimeSeconds(0.1);
    if (!EventFlag(181) && EventFlag(50)) {
        EndEvent();
    }
   if (!EventFlag(50)) {
        ...
        RemoveItemFromPlayer(ItemType.Ring, 6800, 1);
    ...
    if (!EventFlag(1055420001) && !EventFlag(1055420003)) {
        SetEventFlagID(1055420002, ON);
    } else if (EventFlag(1055420001)) {
...
// SACRED Nemesis Aberrant Bindseal
$Event(5750103, Restart, function() {
    if (!EventFlag(181) && EventFlag(50)) {
        EndEvent();
    }
    if (!EventFlag(1055420000)) {
        WaitFor(CharacterHasSpEffect(10000, 1626910));
        $InitializeEvent(0, 5750110);
        if (CharacterHasSpEffect(10000, 1626999)) {
            SetBossBGM(921700, BossBGMState.Stop2);
        }
        ClearSpEffect(10000, 1626999); 
        SetEventFlagID(1055420000, ON);
        SetEventFlagID(1055420001, ON);
        SetEventFlagID(1055420002, OFF);
        SetEventFlagID(1055420010, OFF);
        WaitFixedTimeSeconds(0.5);
        ...
        SetEventFlagID(1055420002, ON);
        RemoveItemFromPlayer(ItemType.Ring, 6800, 1);
        ClearSpEffect(10000, 260);
        ClearSpEffect(10000, 261);
        ClearSpEffect(10000, 263);
        ClearSpEffect(10000, 264);
        ClearSpEffect(10000, 265);
        ClearSpEffect(10000, 266);
        ClearSpEffect(10000, 267);
        ClearSpEffect(10000, 268);
        ClearSpEffect(10000, 269);
        ClearSpEffect(10000, 270);
        ClearSpEffect(10000, 271);
        ClearSpEffect(10000, 272);
        ClearSpEffect(10000, 273);
        SetSpEffect(10000, 1626990);
        ClearSpEffect(10000, 1626913);
        ClearSpEffect(10000, 1626914);
        ClearSpEffect(10000, 1626915);
        ...
        PlaySE(10000, SoundType.SFX, 450264);
        PlaySE(10000, SoundType.SFX, 450264);
        BatchSetEventFlags(1055420090, 1055420097, OFF);
        if (EventFlag(187)) {
            SetEventFlagID(1055420087, ON);
        }
        else if (EventFlag(186)) {
...
$Event(5750105, Default, function() {
...
// SACRED Nemesis Aberrant Knight Darklight Blessings
$Event(5750110, Default, function() {
    if (!EventFlag(1055420001)) {
        EndEvent();
    }
    if (EventFlag(1055422039)) {
        WaitFor(!CharacterHasSpEffect(10000, 1626914));
        WaitFor(!CharacterHasSpEffect(10000, 1697100));
        WaitFor(!CharacterHasSpEffect(10000, 1697001));
        WaitFor(!CharacterHasSpEffect(10000, 1605000));
        WaitFor(!CharacterHasSpEffect(10000, 1626365));
        WaitFor(!CharacterHasSpEffect(10000, 1626360));
        WaitFor(!CharacterHasSpEffect(10000, 1626370));
        WaitRandomTimeSeconds(30, 60);
        if (CharacterHasSpEffect(10000, 1626914) || CharacterHasSpEffect(10000, 1697100) || CharacterHasSpEffect(10000, 1697001) 
        || CharacterHasSpEffect(10000, 1605000) || CharacterHasSpEffect(10000, 1626365) 
        || CharacterHasSpEffect(10000, 1626360) || CharacterHasSpEffect(10000, 1626370)) {
            RestartEvent();
        }
        WaitRandomTimeSeconds(30, 60);
        if (CharacterHasSpEffect(10000, 1626914) || CharacterHasSpEffect(10000, 1697100) || CharacterHasSpEffect(10000, 1697001) 
        ...
        //TODOWaitRandomTimeSeconds(60, 3600);
        WaitRandomTimeSeconds(30, 60);
        SetEventFlagID(1055422039, ON);
        WaitFor(!CharacterHasSpEffect(10000, 1626914));
        WaitFor(!CharacterHasSpEffect(10000, 1697100));
        WaitFor(!CharacterHasSpEffect(10000, 1697001));
        WaitFor(!CharacterHasSpEffect(10000, 1605000));
    ...
    if (!EventFlag(1055420001) || CharacterDead(10000) 
    ...
    BatchSetEventFlags(1055422040, 1055422045, OFF);
    RandomlySetEventFlagInRange(1055422040, 1055422045, ON);
    SetEventFlagID(1055422039, OFF);
    SetSpEffect(10000, 1626986);
    SetSpEffect(10000, 1626991);
    SetSpEffect(10000, 1626992);
    SetSpEffect(10000, 1626998);
    if (EventFlag(1055422040) || EventFlag(1055422041)) {
        $InitializeEvent(0, 5750130);
        AwardItemLot(8200);
        WaitFixedTimeSeconds(2);
        SetSpEffect(10000, 1626995);
        RestartEvent();
    } else if (EventFlag(1055422042) || EventFlag(1055422043) || EventFlag(1055422044) || EventFlag(1055422045)) {
        $InitializeEvent(0, 5750130);
        AwardItemLot(8210);
        WaitFixedTimeSeconds(2);
        SetSpEffect(10000, 1626995);
...
// SACRED Nemesis Aberrant Knight Combat Blessings
$Event(5750111, Default, function() {
    if (!EventFlag(1055420001)) {
        EndEvent();
    }
    if (!EventFlag(1055422049)) {
        //WaitRandomTimeSeconds(30, 600);
        WaitRandomTimeSeconds(5, 6);
    }
    if (!EventFlag(1055420001) || CharacterDead(10000) 
    || CharacterHasSpEffect(10000, 100690) || CharacterHasSpEffect(10000, 9621)) {
        RestartEvent();
    }
    if (!CharacterHasSpEffect(10000, 1626914)) {
        EndEvent();
    }
    if (!EventFlag(1055422049)) {
        SetSpEffect(10000, 1626998);
...
// SACRED Nemesis Eclipse Slayer Sin Eclipse
$Event(5750115, Restart, function() {
    SuppressSE(SoundType.BGM, 0, false);
    SetEventFlagID(1055420010, OFF);
    ClearSpEffect(10000, 1626975);
    ClearSpEffect(10000, 1626999);
    if (!EventFlag(181) && EventFlag(50)) {
        EndEvent();
    }
    ...
    if (EventFlag(187)) {
        //WaitRandomTimeSeconds(60, 1800);
        WaitRandomTimeSeconds(6, 6);  
    }
    else if (EventFlag(186)) {
        //WaitRandomTimeSeconds(60, 3300);
        WaitRandomTimeSeconds(6, 6);  
    }
    else if (EventFlag(185)) {
        //WaitRandomTimeSeconds(60, 4800);
        WaitRandomTimeSeconds(6, 6);  
    }
    else if (EventFlag(184)) {
        //TODOWaitRandomTimeSeconds(60, 6300);
        WaitRandomTimeSeconds(6, 6);
    }
    else if (EventFlag(183)) {
        //TODOWaitRandomTimeSeconds(60, 7800);
        WaitRandomTimeSeconds(6, 6);
    }
    else if (EventFlag(182)) {
        //TODOWaitRandomTimeSeconds(60, 9300);
        WaitRandomTimeSeconds(6, 6);
    }
    else if (EventFlag(181)) {
        //TODOWaitRandomTimeSeconds(60, 10800);
        WaitRandomTimeSeconds(6, 6);
    }
    else if (EventFlag(180)) {
        EndEvent();
    }
    if (EventFlag(1055420001) || EventFlag(1055420003) || CharacterDead(10000) 
    || CharacterHasSpEffect(10000, 100690) || CharacterHasSpEffect(10000, 9621)) {
        WaitFixedTimeSeconds(10);
        RestartEvent();
    }
    if (CharacterHasSpEffect(10000, 4270) || CharacterHasSpEffect(10000, 4271) || CharacterHasSpEffect(10000, 4272) 
    || CharacterHasSpEffect(10000, 4282) || CharacterHasSpEffect(10000, 4286) || CharacterHasSpEffect(10000, 4288)) {
        BatchSetEventFlags(1055422006, 1055422009, OFF); 
        RandomlySetEventFlagInRange(1055422006, 1055422009, ON);
        if (EventFlag(1055422006) || EventFlag(1055422009)) {
            WaitFixedTimeSeconds(10);
            RestartEvent();
        }
    }
    if (!EventFlag(1055420000) && !EventFlag(1055420010)) {
        BatchSetEventFlags(1055422000, 1055422005, OFF); 
        SetEventFlagID(1055420010, ON);  
        SetSpEffect(10000, 1626974);
        SetSpEffect(10000, 1626975);
        SetSpEffect(10000, 1626926);
        SetSpEffect(10000, 1626982);
        SetSpEffect(10000, 1626990);
        SetSpEffect(10000, 1626998);
        ...
        WaitRandomTimeSeconds(0, 60);
        if (!EventFlag(1055420010) || EventFlag(1055420000)) {
            RestartEvent();
        }
        if (CharacterHasSpEffect(10000, 4270) || CharacterHasSpEffect(10000, 4271) || CharacterHasSpEffect(10000, 4272) 
        || CharacterHasSpEffect(10000, 4282) || CharacterHasSpEffect(10000, 4286) || CharacterHasSpEffect(10000, 4288)) {
            BatchSetEventFlags(1055422006, 1055422009, OFF); 
            RandomlySetEventFlagInRange(1055422006, 1055422009, ON);
            if (EventFlag(1055422006)) {
                $InitializeEvent(0, 5750116);
                RestartEvent();
            }
        }
        SetSpEffect(10000, 1626999);
...
// SACRED Nemesis Eclipse Slayer Sin Eclipse Reward
$Event(5750116, Default, function() {   
    ClearSpEffect(10000, 1626975);
    ClearSpEffect(10000, 1626999);
    SetSpEffect(10000, 1626986);
    SetSpEffect(10000, 1626989);
    PlaySE(10000, SoundType.SFX, 450264);
    PlaySE(10000, SoundType.SFX, 450264);
    WaitFixedTimeSeconds(1);
    if (EventValue(1055422000, 6) > 0) {
        DisplayBanner(TextBannerType.Commence);
        PlaySE(10000, SoundType.SFX, 523806);
        WaitFixedTimeSeconds(0.05);
        PlaySE(10000, SoundType.SFX, 523835);
        WaitFixedTimeSeconds(0.05);
        PlaySE(10000, SoundType.SFX, 523875);
    }
    SetEventFlagID(1055420010, OFF);
    ...
    WaitFixedTimeSeconds(0.75);
    if (EventValue(1055422000, 6) == 0) {
    } else if (EventValue(1055422000, 6) <= 2) {
        AwardItemLot(8100); 
    } else if (EventValue(1055422000, 6) <= 4) {
        AwardItemLot(8105); 
    } else if (EventValue(1055422000, 6) <= 6) {
        AwardItemLot(8000); 
        AwardItemLot(8105); 
    } else if (EventValue(1055422000, 6) <= 8) {
        AwardItemLot(8000); 
        AwardItemLot(8110); 
    } else if (EventValue(1055422000, 6) <= 10) {
        AwardItemLot(8000); 
        AwardItemLot(8115); 
    } else if (EventValue(1055422000, 6) <= 12) {
        AwardItemLot(8010); 
        AwardItemLot(8115); 
    } else if (EventValue(1055422000, 6) <= 14) {
        AwardItemLot(8010); 
        AwardItemLot(8120); 
    } else if (EventValue(1055422000, 6) <= 16) {
        AwardItemLot(8010); 
        AwardItemLot(8125); 
    } else if (EventValue(1055422000, 6) <= 18) {
        AwardItemLot(8020); 
        AwardItemLot(8125); 
    } else if (EventValue(1055422000, 6) <= 20) {
        AwardItemLot(8020); 
        AwardItemLot(8130); 
    } else if (EventValue(1055422000, 6) <= 22) {
        AwardItemLot(8020); 
        AwardItemLot(8135); 
    } else if (EventValue(1055422000, 6) <= 24) {
        AwardItemLot(8030);
        AwardItemLot(8135); 
    } else if (EventValue(1055422000, 6) <= 26) {
        AwardItemLot(8030); 
        AwardItemLot(8140); 
    } else if (EventValue(1055422000, 6) <= 28) {
        AwardItemLot(8030); 
        AwardItemLot(8145); 
    } else {
        AwardItemLot(8040); 
...
// SACRED Nemesis Sovereign of War Icon
$Event(5750120, Default, function() {
    if (!EventFlag(1055420003)) {
        EndEvent();
    }
    WaitFixedTimeSeconds(4); 
    if (EventFlag(1055420003) && !CharacterHasSpEffect(10000, 1626967) 
    && !CharacterHasSpEffect(10000, 100690) && !CharacterHasSpEffect(10000, 9621)) {
        SetSpEffect(10000, 1626998);
    }
    WaitFixedTimeSeconds(2); 
    if (EventFlag(1055420003) && !CharacterHasSpEffect(10000, 1626967) && !CharacterDead(10000)) {
        SetSpEffect(10000, 1626997);
        RestartEvent();
    }
    RestartEvent();
...
$Event(5750130, Default, function() {
...
$Event(5750131, Default, function() {
...
$Event(5750132, Default, function() {
    WaitFixedTimeSeconds(0.1);
